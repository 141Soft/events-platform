  ...
  return (
    <UserProvider>
      ...
      <div className='main-content'>
        ...
        <EventList searchParams={searchParams} setEventCount={setEventCount} setError={setError} events={events} setEvents={setEvents} joinedEvents={joinedEvents} setJoinedEvents={setJoinedEvents}/>
      </div>
    </UserProvider>
  )
}
